...
class merge():
    ...
    def Main(self):
        ...
        # 20190823 add USA to US institutions where appropriate
    ...
    def fixCountry(self,COM):
        ...
        '''
        self.states = ['Connecticut','Illinois','Pennsylvania','New~Jersey','Ohio','New York','California','Virginia']
        newCom = {}
        for M in COM:
            affil = COM[M]
