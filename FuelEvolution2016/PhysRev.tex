...
\newcommand{\Yale}{\affiliation{Wright~Laboratory and Department~of~Physics, Yale~University, New~Haven, Connecticut 06520, USA}} %%%% 20170227 add Wright Lab
...
\author{M.~Qi}\NJU
\author{X.~Qian}\BNL
\author{R.~M.~Qiu}\NCEPU
\author{N.~Raper}\RPI\ZSU
\author{J.~Ren}\CIAE
\author{R.~Rosero}\BNL
