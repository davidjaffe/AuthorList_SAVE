...
\newcommand{\CUC}{\affiliation{Catholic University of Chile}}
\newcommand{\CGNPG}{\affiliation{China~Guangdong~Nuclear~Power~Group, Shenzhen}}
...
\author{S.~Hans}\BNL
\author{M.~He}\IHEP
\author{K.~Heeger}\Wisconsin
\author{K.~M.~Heeger}\Wisconsin
\author{Y.~K.~Heng}\IHEP
\author{P.~Hinrichs}\Wisconsin
\author{J.~Hor}\VirginiaTech
